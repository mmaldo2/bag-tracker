...
Registered as `bag-tracker-home` (every 30m at first, changed to hourly on 2026-09-24 after a day of data showed ~5 new matches/day; no-agent) under the `finance` profile. The `.sh` wrapper
